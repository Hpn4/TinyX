...
public class PostService {
  ...
  public List<Post> queryPostsList(List<UUID> postIds) {
    return null;
  }
  ...
  // I don't feel like this function is really necessary, you can use the updatePost system for that
  // matter
  public void updatePostLikes(UUID id, int count) {}

  // I feel like replies can be gathered using the above list endpoint and neo4j, so is this
